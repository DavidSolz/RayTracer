...
plt.fill_between(range(len(frametime)), mean_frametime - np.sqrt(var_frametime), mean_frametime + np.sqrt(var_frametime), color='r', alpha=0.1, label='Frametime ± Variance')
plt.xlabel('Sample')
